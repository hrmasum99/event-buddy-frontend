...
//       // state.isAuthenticated = !!action.payload; // Ensure authenticated if user is set
...
//       // Note: If using HttpOnly cookies, you'll also need to call an API endpoint to clear the cookie.
//     },
//     setAccessToken: (state, action: PayloadAction<string>) => {
//       state.access_token = action.payload;
//       Cookies.set(ACCESS_TOKEN_KEY, action.payload);
//       state.isAuthenticated = true; // Re-authenticate with new token
//     },
//     setTokens: (
//       state,
...
// export const { setLoggedInUser, setUser, logout, setAccessToken, setTokens } =
//   authSlice.actions;
