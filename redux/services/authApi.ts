...
//   tagTypes: ["auth"],
//   endpoints: (builder) => ({
//     signin: builder.mutation<any, LoginType>({
//       query: (credentials) => ({
...
//       }),
//     }),
//     signup: builder.mutation<any, SignupType>({
//       query: (credentials) => ({
...
//     }),
//     // updateProfileFn: builder.mutation<any, {}>({
//     //     query: (credentials) => ({
//     //       url: NEXT_PUBLIC_API_USER_PROFILE_UPDATE,
//     //       method: "PUT",
//     //       body: credentials,
//     //     }),
//     //     transformResponse: (response: ApiSuccessResponse<IAuth>) => response,
