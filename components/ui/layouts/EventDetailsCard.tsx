...
//     // This would typically come from bookings data,
//     // for now we'll use a placeholder calculation
//     const booked = Math.floor(Math.random() * total * 0.3); // Random booked seats for demo
//     return {
...
//   const seatInfo = calculateAvailableSeats();
...
//           >
//             <div className="h-1 w-1 rounded-full bg-[#1D4ED8]" /> {tag}
//           </Badge>
//         ))}
//       </div>
...
//             {seatInfo.available} Spots Left
//           </Link>
//           <span className="text-sm text-[#46444466] font-semibold">
//             ({seatInfo.booked} registered)
//           </span>
//         </div>
//       </CardFooter>
//     </Card>
