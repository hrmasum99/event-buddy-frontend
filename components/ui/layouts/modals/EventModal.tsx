...
// import { CalendarIcon, ClockIcon, UploadCloud } from "lucide-react";
...
//         // Handle image upload for create mode
//         if (formData.imageFile && result.data?.id) {
//           await uploadEventImage({
//             eventId: result.data.id,
//             imageFile: formData.imageFile,
...
//                 />
//                 <ClockIcon className="absolute right-2 top-2.5 h-4 w-4 text-muted-foreground pointer-events-none" />
//               </div>
//             </div>
//           </div>
...
//               <Input
//                 placeholder="e.g. conference, networking"
//                 value={formData.tags}
...
//               <div className="flex flex-col items-center justify-center border border-dashed rounded-md w-full p-4 text-muted-foreground text-center">
